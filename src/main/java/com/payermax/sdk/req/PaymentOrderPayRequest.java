...
public class PaymentOrderPayRequest extends BaseRequest<PaymentOrderPayResponse> implements Serializable {
    ...
    /**
     * 指定到账币种，请参考【[支付方式列表](https://docs.payermax.com/doc-center/disbursement/payment-method-list/southeast-asia.html)】，如有标明到账币种的，需要指定到账币种；若未标明，则到账币种仅支持本币，不需要进行指定
     */
    ...
    public static final class PayeeInfo implements Serializable {
        ...
        /**
         * 目标机构，请参考【[支付方式列表](https://docs.payermax.com/doc-center/disbursement/payment-method-list/southeast-asia.html)】
         */
        ...
        /**
         * 支付方式，请参考【[支付方式列表](https://docs.payermax.com/doc-center/disbursement/payment-method-list/southeast-asia.html)】
         */
